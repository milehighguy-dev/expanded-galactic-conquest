...
function ScriptPostLoad()
    ...
    conquest.OnStart = function(self)
    	conquest.goal1 = AddAIGoal(ATT, "Defend", 30, "gatepanel")
		conquest.goal2 = AddAIGoal(DEF, "Destroy", 30, "gatepanel")
		conquest.goal3 = AddAIGoal(DEF, "Destroy", 10, "woodl")
		conquest.goal4 = AddAIGoal(DEF, "Destroy", 10, "woodc")
		conquest.goal5 = AddAIGoal(DEF, "Destroy", 10, "woodr")
		conquest.goal6 = AddAIGoal(ATT, "Defend", 10, "woodl")
		conquest.goal7 = AddAIGoal(ATT, "Defend", 10, "woodc")
		conquest.goal8 = AddAIGoal(ATT, "Defend", 10, "woodr")
	end
