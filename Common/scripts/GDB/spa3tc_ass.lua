...
--TODO add layer with imperial and alliance vehicles
...
function SetupShields()
    ...
    function shieldStuffCIS:OnAllShieldsDown() 
        ShowMessageText("level.spa.hangar.shields.atk.down", ATT)
        ShowMessageText("level.spa.hangar.shields.def.down", DEF)
		
		BroadcastVoiceOver( "ROSMP_obj_16", ATT )
		BroadcastVoiceOver( "COSMP_obj_17", DEF )
    ...
    function shieldStuffCIS:OnAllShieldsUp()
        ...
        ShowMessageText("level.spa.hangar.shields.atk.up", ATT)
        ShowMessageText("level.spa.hangar.shields.def.up", DEF)
		
		BroadcastVoiceOver( "ROSMP_obj_18", ATT )
		BroadcastVoiceOver( "COSMP_obj_19", DEF )          
    end
    ...
    function shieldStuffREP:OnAllShieldsDown() 
        ShowMessageText("level.spa.hangar.shields.atk.down", DEF)
        ShowMessageText("level.spa.hangar.shields.def.down", ATT)
		
		BroadcastVoiceOver( "ROSMP_obj_17", ATT )
		BroadcastVoiceOver( "COSMP_obj_16", DEF )
    ...
    function shieldStuffREP:OnAllShieldsUp()
        ...
        ShowMessageText("level.spa.hangar.shields.atk.up", DEF)
        ShowMessageText("level.spa.hangar.shields.def.up", ATT)
		
		BroadcastVoiceOver( "ROSMP_obj_19", ATT )
		BroadcastVoiceOver( "COSMP_obj_18", DEF )
    end
end
...
function SetupTurrets() 
    --CIS turrets
    LinkedTurretsCIS = LinkedTurrets:New{ team = DEF, mainframe = "cis_main",
    ...
    function LinkedTurretsCIS:OnDisableMainframe()
        ShowMessageText("level.spa.hangar.mainframe.atk.down", ATT)
        ShowMessageText("level.spa.hangar.mainframe.def.down", DEF)
        
        BroadcastVoiceOver( "ROSMP_obj_20", ATT )
        BroadcastVoiceOver( "COSMP_obj_21", DEF )

    end
    function LinkedTurretsCIS:OnEnableMainframe()
        ShowMessageText("level.spa.hangar.mainframe.atk.up", ATT)
        ShowMessageText("level.spa.hangar.mainframe.def.up", DEF)
        
        BroadcastVoiceOver( "ROSMP_obj_22", ATT )
        BroadcastVoiceOver( "COSMP_obj_23", DEF )

    end
    
    --REP turrets
    LinkedTurretsREP = LinkedTurrets:New{ team = ATT, mainframe = "rep_main",
    ...
    function LinkedTurretsREP:OnDisableMainframe()
        ShowMessageText("level.spa.hangar.mainframe.atk.down", DEF)
        ShowMessageText("level.spa.hangar.mainframe.def.down", ATT)
        
        BroadcastVoiceOver( "ROSMP_obj_21", ATT )
        BroadcastVoiceOver( "COSMP_obj_20", DEF )

    end
    function LinkedTurretsREP:OnEnableMainframe()
        ShowMessageText("level.spa.hangar.mainframe.atk.up", DEF)
        ShowMessageText("level.spa.hangar.mainframe.def.up", ATT)

        BroadcastVoiceOver( "ROSMP_obj_23", ATT )
        BroadcastVoiceOver( "COSMP_obj_22", DEF )
...
function ScriptInit()
    ...
    --  Sound Stats
       ...
       --SetBleedingVoiceOver(REP, ATT, "rep_off_com_report_us_overwhelmed", 1)
       --SetBleedingVoiceOver(REP, DEF, "rep_off_com_report_enemy_losing",   1)
       --SetBleedingVoiceOver(CIS, ATT, "cis_off_com_report_enemy_losing",   1)
       --SetBleedingVoiceOver(CIS, DEF, "cis_off_com_report_us_overwhelmed", 1)
       --
       --SetLowReinforcementsVoiceOver(REP, ATT, "rep_off_defeat_im", .1, 1)
       --SetLowReinforcementsVoiceOver(REP, DEF, "rep_off_victory_im", .1, 1)
       --SetLowReinforcementsVoiceOver(CIS, DEF, "cis_off_defeat_im", .1, 1)
       --SetLowReinforcementsVoiceOver(CIS, ATT, "cis_off_victory_im", .1, 1)
       --
